...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        NSInteger height = kWidth / 1242 * 777;
        self.image = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kWidth, height)];
        [self addSubview:self.image];
        
        CGFloat y = (height - 60) / 2;
        self.title = [[UILabel alloc] initWithFrame:CGRectMake(0, y, kWidth, 30)];
        ...
        self.detail = [[UILabel alloc] initWithFrame:CGRectMake(0, y + 30, kWidth, 30)];
